...
class SensorReader:
    ...
    def read_moisture(self):
        ...
        try:
            import RPi.GPIO as GPIO
            # Read digital value from GPIO21
            moisture_value = GPIO.input(self.moisture_pin)
            
            # For digital moisture sensors, value is typically:
            # 0 = Dry soil, 1 = Wet soil (or vice versa depending on sensor)
    ...
    def read_dht22(self):
        ...
        try:
            ...
            import random
            # Simulate realistic room temperature and humidity
            temperature = round(20.0 + random.uniform(-2, 2), 1)  # 18-22°C range
            humidity = round(45.0 + random.uniform(-5, 5), 1)     # 40-50% range
            return humidity, temperature
        except:
            return None, None
    ...
    def get_soil_type(self, latitude, longitude):
        ...
        try:
            ...
            params = {
                "lat": latitude,
                "lon": longitude,
                "top_k": 1  # Fetch the most probable soil type
            }
    ...
    def send_to_gemini(self, data):
        ...
        try:
            ...
            # Debug: Extract and print plant recommendations in plain text
    ...
    def run(self):
        ...
        # Read sensors once at the start
        self.setup_gpio()
        ...
        # Fetch plant recommendations from Gemini
        plants = self.send_to_gemini(data)
        print("Recommended Plants:")
        for plant in plants:
            print(f"- {plant}")

        # Stop the process after displaying the results
...
def install_dependencies():
    ...
    try:
        subprocess.run([
            ...
            "Adafruit_DHT", "spidev", "RPi.GPIO", "adafruit-circuitpython-dht"
        ], check=True)
        print("Dependencies installed successfully")
    except subprocess.CalledProcessError:
        print("Failed to install dependencies")
        print("Try: sudo apt update && sudo apt install python3-pip")
        print("Then: pip install Adafruit_DHT spidev RPi.GPIO adafruit-circuitpython-dht")
